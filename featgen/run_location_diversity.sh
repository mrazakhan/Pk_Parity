...
python location_diversity.py -if ../data/gsm_sms_oneaccount_pro2_CDRmub_8-14.csv -cc CallerId  -rc ReceiverId -ccc CallerCell -rcc ReceiverCell -of gsm_sms_location_diversity.csv -pf ../data/profile_info.txt
