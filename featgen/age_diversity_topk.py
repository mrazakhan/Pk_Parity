...
def age_diversity(input_file,profile_file, output_file, callerIdCol, receiverIdCol):
    ...
    for k in [2,4]:
        ...
        sf_age=gl.SFrame.read_csv(profile_file,delimiter=',', column_type_hints=str)
        ...
        sf_age_diversity.export_csv('Top{}_'.format(k)+output_file, quote_level=csv.QUOTE_NONE)
