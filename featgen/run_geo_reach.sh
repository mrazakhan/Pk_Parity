...
python geo_reach.py -if ../data/gsm_sms_oneaccount_pro2_CDRmub_8-14.csv -lf ../data/districts.csv -cc CallerId  -rc ReceiverId -ccc CallerCell -rcc ReceiverCell -of gsm_sms_geo_reach.csv
