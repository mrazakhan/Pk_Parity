...
if __name__=='__main__':
	...
	sf=sf.filter_by(1, 'WorkingStatus')
	
	sf_males=sf.filter_by(1, 'gender')
	sf_females=sf.filter_by(0,'gender')
	print 'shape of the Working males df' , sf_males.shape
	print 'shape of the Working females df' , sf_females.shape
	sf_males.export_csv('WorkingMales_'+filename)
	sf_females.export_csv('WorkingFemales_'+filename)
