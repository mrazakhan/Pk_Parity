...
def merge_features(degree_file,volume_file, age_diversity_file,age_diversity_file_top2, age_diversity_file_top4, gender_diversity_file,gender_diversity_file_top2, gender_diversity_file_top4,  location_diversity_file, topological_diversity_file,embeddedness_file, constraints_file,bw_centrality_file,working_status_file,  modal_districts_file,profile_file, output_file):
    ...
    sframes_dict={'volume':sf_volume,'working':sf_working, 'age':sf_age,'age2':sf_age2, 'age4':sf_age4,  'gender':sf_gender,'gender2':sf_gender2, 'gender4':sf_gender4, 'location':sf_location, 'topology':sf_topology, 'embeddedness':sf_embeddedness, 'constraints':sf_constraints,'bw_centrality':sf_bw_centrality}
...
if __name__=='__main__':
    ...
    merge_features(args.degree_file,args.volume_file, args.age_diversity_file,args.age_diversity_file_top2, args.age_diversity_file_top4, args.gender_diversity_file,args.gender_diversity_file_top2, args.gender_diversity_file_top4, args.location_diversity_file, args.topological_diversity_file,args.embeddedness_file, args.constraints_file,args.bw_centrality_file,args.working_status_file,args.modal_districts_file,args.profile_file, args.output_file)
