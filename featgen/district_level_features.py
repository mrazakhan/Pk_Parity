...
def merge_features(input_file,filter_file, output_file):
    ...
    sf_input.rename({'Count':'Volume','gender_diversity':'Gender_Div','Top2_gender_diversity':'Top2_Gender_Div','Top4_gender_diversity':'Top4_Gender_Div','age_diversity':'Age_Div','loc_diversity':'Loc_Div','Top4_age_diversity':'Top4_Age_Div',\
	'Top2_age_diversity':'Top2_Age_Div','topological_diversity':'Net_Div'})
    ...
    for key in sframes_dict:
        ...
        for col in ['Degree','Volume','Gender_Div','Age_Div','Loc_Div','Net_Div','Embeddedness','Constraints','Top4_Gender_Div','Top2_Gender_Div','Top4_Age_Div','Top2_Age_Div']:
